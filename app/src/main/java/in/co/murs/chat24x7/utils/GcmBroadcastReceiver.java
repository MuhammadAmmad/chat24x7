...
import in.co.murs.chat24x7.activities.MainActivity;
...
public class GcmBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            if (GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR.equals(messageType)) {
                ...
                //todo get the consultation whose message is received and show new messages
            }
    ...
    private void sendNotification(String text, boolean launchApp) {
        ...
        if (!TextUtils.isEmpty(MursApplication.getRingtone())) {
            mBuilder.setSound(Uri.parse(MursApplication.getRingtone()));
        }
